...
public class Heap<E> {
    ...
    public E extract() throws IllegalStateException {
        ...
        while (true) {
            ...
            // Determine whether parent, left child, or right child is smallest
            ...
            // If parent is smallest, root has been pushed to correct position
            if (parentIndex == minIndex) {
                break;
            } else {
                // Parent and a child out of order, swap with smaller child
                swapNodes(parentIndex, minIndex);
